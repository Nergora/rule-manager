...
/// <summary>
/// Provides methods required by RuleManager. RuleManager treats providers as singletons per type.
/// </summary>
    ...
    where TInput : RuleInputModel
{
    ...
    /// <returns></returns>
    Task<IDictionary<string, TRuleSet>> GenerateRuleSetsAsync(DateTime after, CancellationToken cancellationToken = default);
    ...
    /// <returns></returns>
    Task<IDictionary<string, bool>> IsExistsAsync(CancellationToken cancellationToken = default, params string[] keys);
}
